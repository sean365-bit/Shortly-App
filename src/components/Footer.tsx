...
function Footer() {
  return (
    <footer>
      <svg className="footer_logo"  xmlns="http://www.w3.org/2000/svg" width="121" height="33">
        <path
          fill="white"
      ...
      <div className="footer_block">
        <p className="block_heading">Features</p>

        <p className="block_content">Link Shortening</p>
        <p className="block_content">Branded Links</p>
        <p className="block_content">Analytics</p>
      </div>

      <div className="footer_block">
        <p className="block_heading">Resources</p>

        <p className="block_content">Blog</p>
        <p className="block_content">Developers</p>
        <p className="block_content">Support</p>
      </div>

      <div className="footer_block">
        <p className="block_heading">Company</p>

        <p className="block_content">About</p>
        <p className="block_content">Our Team</p>
        <p className="block_content">Careers</p>
        <p className="block_content">Contact</p>
      </div>
